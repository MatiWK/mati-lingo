...
export const units = pgTable("units", {
    id: serial("id").primaryKey(),
    title: text("title").notNull(), // eg. unit 1
    description: text("description").notNull(), // eg. learnt he basics of spanish
...
// TODO: check if deleting  "text: text("text").notNull()," breaks the app
